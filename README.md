...
Secret, randomized role assignment each match
Coordinated Werewolf night-kill voting with partner visibility
Medic protection with limited self-protection uses
Seer investigation revealing a target's team allegiance
Public day-phase voting with live vote-count display
Automatic win-condition checking after every phase
Controls
Action	Input
